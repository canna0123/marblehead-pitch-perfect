...
export const Route = createFileRoute("/contact")({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Get in touch with MHD FC — for tryouts, sponsorships, donations, or media enquiries.",
      },
    ],
  }),
  component: Contact,
  ...
  return (
    <div className="bg-background text-foreground">
      ...
      <PageHeader
        ...
        subtitle="Whether you're a prospective player, a sponsor, a partner from a youth organization, or a member of the community looking to support the mission — we'd love to hear from you."
      />
      ...
      <Section>
        <div className="grid md:grid-cols-12 gap-12">
          <div className="md:col-span-5 space-y-8">
            ...
            <div>
              ...
              <p className="text-foreground/75 mt-2 text-sm">
                Operating account held at National Grand Bank. Venmo option coming soon for annual commitments and event
                fundraising.
              </p>
            </div>
            <div>
            ...
            <div className="border-t border-navy-deep/15 pt-6">
              ...
              <p className="text-navy-deep mt-2">
          ...
          <div className="md:col-span-7">
            <form
              className="border border-navy-deep/15 bg-cream p-8 md:p-10 space-y-6"
              onSubmit={(e) => {
                e.preventDefault();
            ...
            >
              ...
              <div className="grid md:grid-cols-2 gap-5">
                <label className="block">
                  ...
                  <input
                    required
                    className="mt-2 w-full bg-transparent border-b-2 border-navy-deep/40 py-2 focus:outline-none focus:border-gold text-lg"
                  />
                </label>
                <label className="block">
              ...
              <label className="block">
                ...
                <select className="mt-2 w-full bg-transparent border-b-2 border-navy-deep/40 py-2 focus:outline-none focus:border-gold text-lg">
                  <option>Player enquiry · 2026/27 Season</option>
              ...
              <label className="block">
                ...
                <textarea
                  rows={6}
                  required
                  className="mt-2 w-full bg-transparent border-b-2 border-navy-deep/40 py-2 focus:outline-none focus:border-gold text-lg resize-none"
                />
              </label>
              <button
                type="submit"
                className="bg-navy-deep text-cream px-8 py-4 font-semibold tracking-wide hover:bg-crimson transition-colors"
              >
                Send Message →
              </button>
            </form>
